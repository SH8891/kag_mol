...
if __name__ == '__main__':
    ...
    wandb.init(project="lig_gpt_kaggle", name=args.run_name)

    data = pd.read_csv('../input/moses-csv/' + args.data_name + '.csv')
    ...
    tconf = TrainerConfig(max_epochs=args.max_epochs, batch_size=args.batch_size, learning_rate=args.learning_rate,
                            ...
                            num_workers=10, ckpt_path=f'../working/weights/{args.run_name}.pt', block_size=train_dataset.max_len, generate=False)
